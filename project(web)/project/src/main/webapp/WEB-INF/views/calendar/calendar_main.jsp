                    ...
                    <div class="board-list">
                        <table border="1" class="cal">
                            <tr class="center tr">
                                ...
                                <td class="p-3 td-12">
                                    <input type="text" id="startDate" class="td-80" />
                                    <span class="i"><i class="far fa-calendar-alt"></i></span>
                                </td>
                                <td class="bg-eee td-8">종료일</td>
                                <td class="p-3 td-12">
                                    <input type="text" id="endDate" class="td-80" />
                                    <span class="i"><i class="far fa-calendar-alt"></i></span>
                                </td>
                                ...
                                <td class="p-3 td-15">
                                    <input type="text" placeholder="사원명을 입력하세요." />
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="center m-t5 m-b10">
                        <button class="btn-blue" onClick="">일정 등록</button>
                        <button class="btn-white">새로고침</button>
                    </div>
                    <div class="title m-b10 bold">
