                ...
                <div class="page-wrap">
                    ...
                    <div class="btn-box m-b5">
                        ...
                        <button type="button" class="btn-white"
                            onclick="{pageContext.request.contextPath}/location.href='article_list'">목록으로</button>
                    </div>
                    ...
                    <div class="center m-t5">
                        <button class="btn-blue" onclick="{pageContext.request.contextPath}/location.href='article_list'">등록하기</button>
                    </div>
                </div>
            </div>
		</div>
