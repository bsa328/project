			...
			<div class="main">
                <div class="page-wrap">
                    ...
                    <div class="board-list">
                        <table border="1">
                            ...
                            <tr class="center">
                                ...
                                <td>영업부</td>
                                <td>notice</td>
                                <td class=""><a href="article_list.html" target="_blank">연말 행사 및 축제 공고입니다.</a></td>
                                <td>모두</td>
                                <td>#fff</td>
                            ...
                            <tr class="center">
                                ...
                                <td>생산부</td>
                                <td>normal</td>
                                <td class=""><a href="article_list.html" target="_blank">자유게시판입니다.</a></td>
                                <td>해당부서만</td>
                                <td>#ccc</td>
                                <td class="">2021-01-14</td>
                            </tr>
                    ...
                    <div class="search-box m-t5">
                        <div class="total-num">전체 게시판수 : ?개</div>
                        <div class="">
