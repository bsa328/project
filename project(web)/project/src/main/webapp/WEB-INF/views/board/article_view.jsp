			...
			<div class="main">
				<div class="page-wrap">
					...
					<div class="btn-box m-b5">
						<button></button>
						<button class="btn-white" onclick="location.href='${pageContext.request.contextPath}/article/article_list'">목록으로</button>
					</div>
					<div class="board-list">
						<table border="1">
							<tr class="center">
								<td class="bg-eee td-10">게시글 분류</td>
								<td class="p-10 left" colspan="3">공지사항</td>
							</tr>
							<tr class="center">
								<td class="bg-eee td-10">게시글 제목</td>
								<td class="p-10 left" colspan="3">영업팀 공지사항입니다. 반드시 필독!</td>
							</tr>
							<tr class="center">
							...
							<tr class="center">
								...
								<td class="p-10 left top" style="height: 320px;" colspan="3">영업팀 공지입니다.</td>
							</tr>
							<tr class="center">
					...
					<div class="center m-t5">
						<button class="btn-blue" onclick="location.href='${pageContext.request.contextPath}/article/article_modify'">게시물 수정</button>
