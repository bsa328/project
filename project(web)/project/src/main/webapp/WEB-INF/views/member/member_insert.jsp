	...
	<div class="html">
		...
		<div class="body">
			...
			<div class="main">
				<div class="page-wrap">
					<div class="title">
						<span class=""><i class="fas fa-cube"> 회원관리 > 회원목록 > 회원등록</i></span>
					</div>
					...
					<form id="frm" method="POST" action="${pageContext.request.contextPath}/member/member_insert" autocomplete="off">
							...
							<div class="info-table">
								<table border="1" class="insert-box center">
									<tr class="">
										...
										<td class="p-5 td-23">
											<input type="text" class="td-100" placeholder="4~10자리" />
										</td>
										<td class="td-10 bg-blue">비밀번호</td>
										<td class="p-5 td-23">
											<input type="text" class="td-100" value="" placeholder="5자리 이상" />
										</td>
									</tr>
									<tr class="">
						...
						<div class="center m-t10">
							<button class="td-7 btn-blue" type="submit">등록하기</button>
							<button class=""></button>
						</div>
					</form>
